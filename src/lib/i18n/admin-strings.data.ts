...
export const EN_STRINGS: Record<string, string> = {
  ...
  // M22: customer portal activation + admin customers
  "Hai ricevuto un link di attivazione da GommaRush? Aprilo per scegliere la tua password.": "Did you receive an activation link from GommaRush? Open it to choose your password.",
  "Accesso ATTIVO": "Access ACTIVE",
  "Accesso NON ATTIVO": "Access NOT ACTIVE",
  "Ultimo accesso": "Last sign-in",
  "Nuovo link di attivazione": "New activation link",
  "Link per nuova password": "New password link",
  "Nuovo link per": "New link for",
  "Invia questo link al cliente: aprendolo sceglierà la sua password. Il link vale una sola volta e scade dopo un tempo limitato; se scade, generane uno nuovo.": "Send this link to the customer: opening it, they choose their own password. The link works once and expires after a limited time; if it expires, generate a new one.",
  "Copiato": "Copied",
  "Copia link": "Copy link",
  "Chiudi": "Close",
  "Aggiungi prima un luogo di consegna con indirizzo e città: senza, il cliente non può completare un ordine.": "Add a delivery location with street and city first: without one, the customer cannot complete an order.",
  "Email di accesso del cliente": "Customer login email",
  "Riceverai un link di attivazione da inviare al cliente. Nessuna password passa dall'amministrazione.": "You will get an activation link to send to the customer. No password goes through the admin.",
  "Crea accesso e link di attivazione": "Create access and activation link",
  "In attesa di attivazione": "Awaiting activation",
  "Nuovo cliente": "New customer",
  "Crea cliente": "Create customer",
  "Annulla": "Cancel",
  "Nome azienda": "Company name",
  "Luogo di consegna": "Delivery location",
  "con indirizzo completo": "with a complete address",
  "Manca un indirizzo con via e città — aggiungilo qui sotto.": "An address with street and city is missing — add it below.",
  "Crea l'accesso e invia il link di attivazione al cliente.": "Create the access and send the activation link to the customer.",
  "Nessun ordine dal portale.": "No orders from the portal.",
  "Ordini trasporto": "Transport orders",
  "La password deve avere almeno 10 caratteri.": "The password must be at least 10 characters.",
  "Le due password non coincidono.": "The two passwords do not match.",
  "Attivazione non riuscita. Riprova.": "Activation failed. Try again.",
  ...
  "Attiva accesso": "Activate access",
  "Imposta la tua password": "Set your password",
  "Attiva il tuo accesso": "Activate your access",
  "Scegli la password con cui accederai all'area clienti GommaRush.": "Choose the password you will use to sign in to the GommaRush customer account.",
  "Il link non è valido o è scaduto. Chiedi a GommaRush un nuovo link di attivazione.": "The link is invalid or has expired. Ask GommaRush for a new activation link.",
  "Vai all'accesso": "Go to sign-in",
  "Inserisci un indirizzo email valido.": "Enter a valid email address.",
  "Questa email ha già un accesso GommaRush (cliente, staff o autista). Usa un'altra email per questo cliente.": "This email already has a GommaRush login (customer, staff or driver). Use another email for this customer.",
  "Cliente non trovato o non attivo.": "Customer not found or not active.",
  "Creazione dell'accesso non riuscita. Riprova.": "Creating the access failed. Try again.",
  "Collegamento dell'accesso al cliente non riuscito. Riprova.": "Linking the access to the customer failed. Try again.",
  "Accesso non trovato o disattivato.": "Access not found or disabled.",
  "Generazione del link non riuscita. Riprova.": "Generating the link failed. Try again.",
  "Operazione non riuscita.": "Operation failed.",
  "Password non accettata. Chiedi a GommaRush un nuovo link e scegli una password più lunga.": "Password not accepted. Ask GommaRush for a new link and choose a longer password.",
  "Troppi tentativi. Riprova tra qualche minuto.": "Too many attempts. Try again in a few minutes.",
  // M23: sales-order workflow
  "Decisione": "Decision",
  "Stato finale: nessuna azione disponibile.": "Final status: no action available.",
  "Motivo": "Reason",
  "Conferma": "Confirm",
  "Ordine al fornitore": "Supplier order",
  "Stato ordine": "Order status",
  "Cerca per numero ordine": "Search by order number",
  "Nessun ordine con questo numero.": "No order with this number.",
  "Nessun ordine in questo stato.": "No orders in this status.",
  "Storico": "History",
  "La gestione stati non è ancora attivata nel database (migrazione 0008).": "Status management is not activated in the database yet (migration 0008).",
  "Nessuna modifica di stato.": "No status changes.",
  "Torna agli ordini clienti": "Back to customer orders",
  "Da rivedere": "To review",
  "In attesa di pagamento": "Awaiting payment",
  "Segna in attesa di pagamento": "Mark as awaiting payment",
  "Rifiuta ordine": "Reject order",
  "Annulla ordine": "Cancel order",
  "Lo stato dell'ordine è cambiato nel frattempo. Ricarica la pagina.": "The order status changed in the meantime. Reload the page.",
  "Questo passaggio non è consentito dallo stato attuale.": "This step is not allowed from the current status.",
  "Indica il motivo.": "Give the reason.",
