...
const it = {
  ...
  // --- hero -----------------------------------------------------------
  heroTitle: "Pneumatici per gommisti nell'area di Firenze, quando servono e al giusto prezzo.",
  heroSubtitle:
  ...
  successBodyPrefix: "Abbiamo ricevuto la tua richiesta. Prepariamo l'offerta e la invieremo a:",
...
const en: SiteCopy = {
  ...
  heroTitle: "Tyres for tyre shops around Florence — when you need them, at the right price.",
  heroSubtitle:
  ...
  successBodyPrefix: "We've received your request. We'll prepare the offer and send it to:",
