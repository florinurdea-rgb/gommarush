...
/**
 * "Importa listino" — a manual supplier catalogue upload.
 *
 * SECONDARY since M11B. The primary Catalogue screen is now Browse & Compare
 * at /admin/catalogue; this is the occasional action of loading a file by
 * hand, which still matters for a supplier with no feed (Carlini) and for
 * re-importing a correction. The Inter-Sprint feed arrives automatically and
...
export default async function CataloguePage() {
  ...
  return (
    <>
      <PageHeading
        title={tr("Importa listino")}
        description={tr("Carica manualmente il listino di un fornitore. Il flusso Inter-Sprint arriva da solo.")}
      />

      <p className="mb-5 text-sm">
        <Link href="/admin/catalogue" className="font-semibold text-accent hover:underline">
          {tr("← Torna al catalogo")}
        </Link>
      </p>
