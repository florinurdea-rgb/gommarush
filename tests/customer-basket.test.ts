...
function line(resolution:BasketResolvedLine["internal"]["resolution"]):BasketResolvedLine{
 ...
 return {input:{productId:"11111111-1111-1111-1111-111111111111",oldDot:false,quantity:4},customer:{tyre,availability:"in_stock",tyreSaleNetCents:10000,pfuStatus:complete?"MANUAL_CONFIRMED":"TO_CONFIRM",pfuAmountCents:complete?200:null,pfuEstimated:false,pfuEstimateVersion:null,vatAmountCents:complete?2244:null,customerTotalCents:complete?12444:null,priceAvailable:true},internal:{tyre,availability:"in_stock",supplierStockExact:20,supplierStockMinimum:null,supplierStockRaw:"20",sellable:true,sellabilityReason:"sellable",minimumOfferQuantity:5,supplierListingId:"internal-listing",supplierName:"SECRET",supplierArticleId:"SECRET-SKU",costObservedAt:"2026-09-22T00:00:00Z",resolution,supplierCostCents:8000,markupPercentApplied:20,markupAmountCents:2000,minimumProfitApplied:false,tyreSaleNetCents:10000,pfuStatus:complete?"MANUAL_CONFIRMED":"TO_CONFIRM",pfuAmountCents:complete?200:null,pfuEstimated:false,pfuEstimateVersion:null,taxableSubtotalCents:complete?10200:null,vatRatePercentApplied:complete?22:null,vatAmountCents:complete?2244:null,customerTotalCents:complete?12444:null,grossProfitCents:2000,grossMarginPercent:20,blockedReasons:[]}};
}
